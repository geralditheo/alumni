        ...
        <Modal.Body>
            <form onSubmit={handleSubmit(onSubmit)} >
                ...
                <div className="flex flex-col gap-1 mb-5">
                    ...
                    <select {...register('teamwork')} name="teamwork" id="teamwork"  >
                ...
                <div className="flex flex-col gap-1 mb-5">
                    ...
                    <select {...register('expertiseIt')} name="expertiseIt" id="expertiseIt"  >
                            <option value="" >-none-</option>
                            { optionsTinkatKemampuan?.map((item) => {
                                return <option key={item.key} value={item.value} >{item.label}</option>
                            })}
                ...
                <div className="flex flex-col gap-1 mb-5">
                    ...
                    <select {...register('expertiseEnglish')} name="expertiseEnglish" id="expertiseEnglish"  >
                            <option value="" >-none-</option>
                            { optionsTinkatKemampuan?.map((item) => {
                                return <option key={item.key} value={item.value} >{item.label}</option>
                            })}
                ...
                <div className="flex flex-col gap-1 mb-5">
                    ...
                    <select {...register('expertiseCommunication')} name="expertiseCommunication" id="expertiseCommunication"  >
                            <option value="" >-none-</option>
                            { optionsTinkatKemampuan?.map((item) => {
                                return <option key={item.key} value={item.value} >{item.label}</option>
                            })}
                ...
                <div className="flex flex-col gap-1 mb-5">
                    ...
                    <select {...register('selfDevelopment')} name="selfDevelopment" id="selfDevelopment"  >
                            <option value="" >-none-</option>
                            { optionsTinkatKemampuan?.map((item) => {
                                return <option key={item.key} value={item.value} >{item.label}</option>
                            })}
                ...
                <div className="flex flex-col gap-1 mb-5">
                    ...
                    <select {...register('leadership')} name="leadership" id="leadership"  >
                            <option value="" >-none-</option>
                            { optionsTinkatKemampuan?.map((item) => {
                                return <option key={item.key} value={item.value} >{item.label}</option>
                            })}
                ...
                <div className="flex flex-col gap-1 mb-5">
                    ...
                    <select {...register('workEtnic')} name="workEtnic" id="workEtnic"  >
                            <option value="" >-none-</option>
                            { optionsTinkatKemampuan?.map((item) => {
                                return <option key={item.key} value={item.value} >{item.label}</option>
                            })}
