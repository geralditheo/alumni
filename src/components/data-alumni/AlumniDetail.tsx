    ...
    return (
        <Modal show={show} onClose={done} size="7xl" >
            ...
            <Modal.Body>
                                    ...
                                    <div className='p-3 flex justify-between'>
                                        <div className="space-y-6">
                                            <div className="flex items-start">
                                                <div>
                                                    <h3 className="text-lg font-semibold text-gray-800">{item.jenjang_pendidikan}</h3>
                ...
                <div className="border rounded-md bg-white mb-3" >
                    <h3 className="p-3 rounded-t-md font-semibold bg-blue-400 text-white" >Award</h3>
                    {
                                ...
                                <div key={`${index}-awa`} className="p-3 text-sm " >
                                    <div className='p-3 flex justify-between'>
                                        <div className="space-y-6">
                                            <div className="flex items-start">
                                                <div>
                                                   <h3 className="text-lg font-semibold text-gray-800">{item.nama_award}</h3>
                                ...
                                <div key={`${index}-crs`} className="p-3 text-sm " >
                                    <div className='p-3 flex justify-between'>
                                        <div className="space-y-6">
                                            <div className="flex items-start">
                                                <div>
                                                <h3 className="text-lg font-semibold text-gray-800">{item.nama_course}</h3>
                                ...
                                <div key={`${index}-intr`} className="p-3 text-sm " >
                                    <div className='p-3 flex justify-between'>
                                        <div className="space-y-6">
                                            <div className="flex items-start">
                                                <div>
                                                    <h3 className="text-lg font-semibold text-gray-800">{item.nama_intern}</h3>
                                ...
                                <div key={`${index}-jbs`} className="p-3 text-sm " >
                                    <div className='p-3 flex justify-between'>
                                        <div className="space-y-6">
                                            <div className="flex items-start">
                                                <div>
                                                    <h3 className="text-lg font-semibold text-gray-800">{item.nama_job}</h3>
                                ...
                                <div key={`${index}-org`} className="p-3 text-sm " >
                                    <div className='p-3 flex justify-between'>
                                        <div className="space-y-6">
                                            <div className="flex items-start">
                                                <div>
                                                    <h3 className="text-lg font-semibold text-gray-800">{item.nama_org}</h3>
