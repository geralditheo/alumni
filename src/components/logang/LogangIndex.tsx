                    ...
                    <div className="bg-gray-100 rounded-md p-3 border border-blue-500" >
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} >
                            ...
                            <Accordion collapseAll >
                                ...
                                <Accordion.Panel >
                                    <Accordion.Title className="text-sm" >Tipe Magang</Accordion.Title>
                                    <Accordion.Content className="text-sm" >
                                ...
                                <div onClick={() => onClickButton(String(item.id))} key={item.id} className="bg-white shadow flex flex-col sm:flex-row gap-3 p-3 border border-blue-500 rounded-md mb-3" >
                                    <div className="flex justify-center"  >
                                        <div className='w-52 aspect-square relative border' >
                                            <Image src={item?.Logo ? `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/storage/imglogo/${item.Logo}` : ''} alt={`${item?.NamaPerusahaan || 'Perusahaan'} Logo`} fill className='object-cover m-auto w-full h-full ' />
                                        </div>
                                    </div>
