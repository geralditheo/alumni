...
export const useCheckDataAlumni = create<State & Action>((set) => ({
    ...
    data: [
        ...
        { key: 'a5', name: "Achievement", isFilled: false, count: 0, lastUpdted: null, path: "award" },
        { key: 'a6', name: "Certificate", isFilled: true , count: 3, lastUpdted:  new Date('10/7/2024'), path: "course"},
